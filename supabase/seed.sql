...
insert into public.quests (
  ...
  ('20000000-0000-0000-0000-000000000001', 'mimi-welcome', id('cats', 'mimi'), '咪咪的见面', '和咪咪的第一次相遇，居然摸到了脑袋！', 'dialogue', 1, 0, 'liked_post:first-morning', 10, '咪咪的见面卡片', '我是掌管吃饭和睡觉的咪。', 'cards/mimi-card-1.jpg'),
  ('20000000-0000-0000-0000-000000000002', 'night-fishing', id('cats', 'mimi'), '钓一条鱼', '咪咪想吃夜宵了，去找一条鱼吧！', 'fishing', 2, 1, 'quest_completed:mimi-welcome', 15, '咪咪的夜宵感谢信', '“告诉老默，我想吃鱼了”', 'cards/mimi-card-2.jpg'),
  ('20000000-0000-0000-0000-000000000003', 'gian-welcome', id('cats', 'gian'), '胖虎的见面', '和胖虎的第一次相遇，真是猫不可相貌。', 'dialogue', 1, 0, 'quest_completed:night-fishing', 10, '胖虎的见面卡片', '横看成球侧成球', 'cards/gian-card-1.jpg'),
  ('20000000-0000-0000-0000-000000000004', 'new-game', id('cats', 'gian'), '猫咪的新游戏', '来帮胖虎完代打合成大猫咪吧！', 'merge', 2, 1000, 'quest_completed:gian-welcome', 15, '胖虎的游戏代打感谢', '什么好康的，是新游戏吗', 'cards/gian-card-2.jpg'),
  ('20000000-0000-0000-0000-000000000005', 'baga-welcome', id('cats', 'baga'), '嘎子的见面', '和嘎子的第一次相遇，看起来就不好惹。', 'dialogue', 1, 0, 'quest_completed:gian-welcome', 10, '嘎子的见面卡片', '猫中大佐', 'cards/baga-card-1.jpg'),
  ('20000000-0000-0000-0000-000000000006', 'more-fishes', id('cats', 'mimi'), '再钓一条鱼', '咪咪的鱼吃完了，再去找一条鱼吧！', 'fishing', 3, 2, 'quest_completed:baga-welcome', 20, '咪咪的鱼子护身符', '有了这个护身符，钓鱼永不空军', 'cards/mimi-card-3.jpg'),
  ('20000000-0000-0000-0000-000000000007', 'baga-merge', id('cats', 'baga'), '代肝业务拓展', '嘎子看到胖虎在玩新游戏，决定要超过他', 'merge', 3, 1500, 'quest_completed:new-game', 15, '嘎子的奇妙自拍', '嘘，不要告诉其他人', 'cards/baga-card-2.jpg'),
  ('20000000-0000-0000-0000-000000000008', 'coco-welcome', id('cats', 'coco'), '可可的见面', '和可可的第一次相遇，真是可爱到犯规。', 'dialogue', 1, 0, 'quest_completed:baga-merge', 10, '可可的见面卡片', '可可是一只只会贴贴的猫咪', 'cards/coco-card-1.jpg'),
  ('20000000-0000-0000-0000-000000000009', 'ending', id('cats', 'dogy'), '写在最后的话', '欢迎入驻！', 'dialogue', 1, 0, 'quest_completed:coco-welcome', 100, '2026.5.20', '520礼物合照：记录每一朵玫瑰', 'cards/ending-card.jpg'),
  ('20000000-0000-0000-0000-000000000010', 'A new beginning', id('cats', 'miea'), '新的开始', '猫书迎来了它的第二位幕后黑手，新的版本开始书写^^', 'dialogue', 1, 0, 'quest_completed:ending', 100, '2026.5.23', '爱来自咩', 'cards/A new beginning.jpg'),
  ('20000000-0000-0000-0000-000000000011', 'huihui-welcome', id('cats', 'huihui'), '灰芝麻的见面', '和灰芝麻的第一次相遇，感觉被瞪了是怎么回事……', 'dialogue', 1, 0, 'quest_completed:A new beginning', 10, '灰芝麻的见面卡片', '看什么看？！', 'cards/huihui-card-1.jpg'),
  ('20000000-0000-0000-0000-000000000012', 'mimi-tarot', id('cats', 'mimi'), '咪咪的占卜', '来试试最聪明的咪咪会占卜到什么呢……？', 'dialogue', 1, 0, null, 10, 'null', 'null', null),
  ('20000000-0000-0000-0000-000000000013', 'huihui-paw', id('cats', 'huihui'), '猫爪在上原则', '看准灰芝麻的爪爪伸出来的时机，轻轻拍中！', 'paw_on_top', 1, 0, 'quest_completed:A new beginning', 10, '灰芝麻的jiojio', '山竹！让我摸摸！', 'cards/huihui-card-2.jpg')
on conflict (id) do update set
  slug = excluded.slug,
...
insert into public.posts (
  ...
  ('30000000-0000-0000-0000-000000000002', 'mimi-welcome', id('cats', 'mimi'), id('quests', 'mimi-welcome'), '居然有新人赞我！有没有扩列dd ´ₒ⦁⩊⦁ₒ`', '咪咪的见面卡片', 'posts/mimi-post-2.jpg', 'liked_post:first-morning', 'free', null, 2, default),
  ('30000000-0000-0000-0000-000000000003', 'night-fishing', id('cats', 'mimi'), id('quests', 'night-fishing'), '刚准备躺下又饿了。。。 有没有好心人打赏份夜宵', '夜钓', 'posts/mimi-post-3.jpg', 'quest_completed:mimi-welcome', 'free', null, 3, default),
  ('30000000-0000-0000-0000-000000000004', 'gian-welcome', id('cats', 'gian'), id('quests', 'gian-welcome'), '所以这个网站能点外卖吗', '胖虎霸气走来', 'posts/gian-post-1.jpg', 'quest_completed:night-fishing', 'free', null, 4, default),
  ('30000000-0000-0000-0000-000000000005', 'new-game', id('cats', 'gian'), id('quests', 'new-game'), '合成大猫咪代肝招募，需要一位电竞高手', '坐着的胖虎', 'posts/gian-post-2.jpg', 'quest_completed:gian-welcome', 'free', null, 5, default),
  ('30000000-0000-0000-0000-000000000006', 'baga-welcome', id('cats', 'baga'), id('quests', 'baga-welcome'), '锐评自拍不玻璃心', '嘎子的自拍', 'posts/baga-post-1.jpg', 'quest_completed:gian-welcome', 'free', null, 6, default),
  ('30000000-0000-0000-0000-000000000007', 'more-fishes', id('cats', 'mimi'), id('quests', 'more-fishes'), '好饿！为什么一条鱼这么小！', '寻找食物的咪咪', 'posts/mimi-post-4.jpg', 'quest_completed:baga-welcome', 'free', null, 7, default),
  ('30000000-0000-0000-0000-000000000008', 'baga-merge', id('cats', 'baga'), id('quests', 'baga-merge'), '冲分合成大猫咪，有接单的小窗我', '虎视眈眈的嘎子', 'posts/baga-post-2.jpg', 'quest_completed:new-game', 'free', null, 8, default),
  ('30000000-0000-0000-0000-000000000009', 'coco-welcome', id('cats', 'coco'), id('quests', 'coco-welcome'), '太阳这么暖洋洋，一定也是大橘吧', '可可的见面卡片', 'posts/coco-post-1.jpg', 'quest_completed:baga-merge', 'free', null, 9, default),
  ...
  ('30000000-0000-0000-0000-000000000015', 'huihui-paw', id('cats', 'huihui'), id('quests', 'huihui-paw'), '我的原则是猫爪在上。', '谁能忍住不摸', 'posts/huihui-post-2.jpg', 'quest_completed:A new beginning', 'free', null, 14, default),
...
insert into public.dialogue_nodes (
  ...
  ('60000000-0000-0000-0000-000000000008', id('cats', 'mimi'), 'mimi-like', '最特别的波波', '熟悉之后，总是能找到波波睡觉的小窝，睡着了叫它就会打哈欠然后扁扁地走过来躺下让人摸摸继续睡的绝世好咪。爱你波波', 100, 3),
  ('60000000-0000-0000-0000-000000000003', id('cats', 'gian'), 'gian-first-meet', '胖虎的第一次见面', '面相凶猛的胖虎，但看到干饭的样子就知道是没有坏心眼的憨厚呆咪', 0, 1),
  ('60000000-0000-0000-0000-000000000004', id('cats', 'gian'), 'gian-second-meet', '^ω^', ' ', 50, 2),
  ('60000000-0000-0000-0000-000000000005', id('cats', 'gian'), 'gian-thrd-meet', '^ω^', ' ', 100, 3),
  ('60000000-0000-0000-0000-000000000006', id('cats', 'dogy'), 'dogy-dogy', '好感度', '狗子好感度永远是100%', 0, 1),
  ('60000000-0000-0000-0000-000000000007', id('cats', 'miea'), 'miea-miea', '好感度', '咩咩永远爱你^333333^', 0, 1)
