...
insert into public.quests (
  ...
  title,              -- 任务标题
  description,        -- 任务说明
  type,               -- 任务类型，如 dialogue/fishing/merge
  game_key,           -- 前端玩法入口标识，如 dialogue/fishing/merge_cats
...
insert into public.posts (
  ...
  image_path,  -- 帖子图片路径，相对 public/resources
  ...
  ('30000000-0000-0000-0000-000000000012', 'huihui-welcome', '10000000-0000-0000-0000-000000000007', null, '怎么感觉有奇怪的两脚兽混进来了', '灰芝麻正在注视着你', 'posts/huihui-post-1.jpg', 'quest_completed:A new beginning', 11)
