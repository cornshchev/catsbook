insert into public.cats (id, slug, name, handle, avatar_emoji, avatar_path, bio, personality, likes) values
  ('10000000-0000-0000-0000-000000000001', 'dogy', '二狗', 'dogy@catsbook.com', '狗', null, '本网站的幕后黑手，如果遇到了bug，请在论坛上发帖求助，毕竟猫师傅都是专业的！', '懒癌晚期，但怎么能压力一只小狗呢！', array['咩咩', '鱿鱼丝', '咩咩']),
...
insert into public.dialogue_nodes (id, cat_id, slug, title, body, min_affection, sort_order) values
  ...
  ('40000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000002', 'mimi-real-name', '刘波', '咪咪原来有大名！一起前来看望咪咪的学姐透露到', 50, 2),
